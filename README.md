...
* Line-by-line descriptions of the C-language code in the sample applications packaged with the SDK. See [Sample Application](https://docs.lantronix.com/products/xpico-200/sdk/1.7/sample-apps/). 
