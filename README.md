...
This multi-page html [SDK guide](https://docs.lantronix.com/products/xpico-200/sdk/1.7/) teaches SDK users how to create, build, and  deploy firmware to an embedded gateway device. It includes the following types of information:

* Getting started information about how to find and install the SDK and a tutorial that walks users through building and deploying the Hello World demo. See [Getting Started](https://docs.lantronix.com/products/xpico-200/sdk/1.7/getting-started/). 
...
* Line-by-line descriptions of the C-language code in the sample applications that are packaged with the SDK. See [Sample Application](https://docs.lantronix.com/products/xpico-200/sdk/1.7/sample-apps/). 
...
This SDK guide is written in Markdown (except the Doxygen-generated content) and published using Mkdocs. 

<a href="https://mollieswenson.github.io/slate/"><img src="resources/xpico200.png" style="box-shadow: 1px 1px 1px 1px grey;"/></a>
