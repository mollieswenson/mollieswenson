...
* Detailed information about what is happening in the C-language code used in the sample applications. See [Sample Applications](https://docs.lantronix.com/products/xpico-200/sdk/1.7/sample-apps/). 
...
* Getting started content, with quick-start tutorials that let users build and deploy working firmware in just a few clicks. See [Getting Started](https://docs.lantronix.com/products/xpico-200/sdk/1.7/getting-started/). 
